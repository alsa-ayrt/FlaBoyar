...
if TYPE_CHECKING:
    ...
    from actors.entity import Item
...
class InventoryHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.console.Console) -> None:
        ...
        number_of_items_inventory = len(self.engine.player.inventory.items)

        height = number_of_items_inventory + 2
        ...
        if number_of_items_inventory > 0:
